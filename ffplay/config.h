...
#define FFMPEG_CONFIGURATION "--disable-decoders --disable-encoders --disable-filters --disable-parsers --disable-protocols --disable-bsfs --disable-demuxers --disable-muxers --disable-indevs --disable-outdevs --disable-doc --disable-ffprobe --enable-protocol='concat,file' --enable-demuxer='mpegts,mp2,mp3,aac,h264,pcm_s16le,mjpeg,dvbsub' --enable-parser='aac,h264,mpeg4video,mpegvideo,mpegaudio,mjpeg,aac_latm,dvbsub' --enable-decoder='mp2,mp3,aac,h264,mpeg2video,mpeg4,mjpeg,aac_latm,dvbsub' --enable-bsf=aac_adtstoasc --enable-filter='transpose,aresample' --enable-outdev=sdl2 --enable-gpl --enable-nonfree"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2020
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "gcc 9 (Ubuntu 9.3.0-10ubuntu2)"
